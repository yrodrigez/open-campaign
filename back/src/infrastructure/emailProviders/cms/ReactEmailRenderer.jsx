...
var ReactEmailComponents = require("@react-email/components");
var uuidv4_1 = require("uuidv4");
// @ts-ignore
var react_1 = require("react");
var ReactEmailRenderer = /** @class */ (function () {
    function ReactEmailRenderer() {
    }
    ...
    ReactEmailRenderer.prototype.convertJsonToJsx = function (emailJson) {
        var _this = this;
        var type = emailJson.type, _a = emailJson.props, props = _a === void 0 ? {} : _a;
        var Component = ReactEmailComponents[type];
        if (!Component) {
            throw new Error("The component with type ".concat(type, " is not available in ReactEmailComponents"));
        }
        if (!props.key)
